...
qx.Class.define("appudo_cli_creator.view.desktop.OperationListFilter",
{
    ...
    members : 
    {
      ...
      __doFilter : function() {
          this.__controller.operationsFilter(this.getValue());
      },
    ...
    construct : function(controller)
    {
        var _this = this;
        this.base(arguments);
        this.setPlaceholder(this.tr('Filter Operations...'));
